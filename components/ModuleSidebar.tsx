...
const MENU_CONFIG: MenuItem[] = [
  { href: '/superadmin/users', label: 'Approval User', roles: ['SUPERADMIN'], icon: UserCog, module: 'settings' },
    { href: '/superadmin/audit-log', label: 'Log Aktivitas', roles: ['SUPERADMIN', 'DIREKTUR', 'DIREKSI'], icon: Activity, module: 'settings' },
  ...
  { href: '/collecting/upload', label: 'Upload Nominatif', roles: ['SUPERADMIN', 'KASUBAG_KREDIT', 'KASUBAG_KREDIT_PUSAT_1', 'KASUBAG_KREDIT_PUSAT_2', 'KASUBAG_KREDIT_CABANG'], icon: PlusCircle, module: 'collecting' },
      ...
      <div className="app-sidebar-header">
        <div className="app-logo">
          <div className="app-logo-icon" style={{ background: 'transparent', color: 'inherit' }}>
            <img src="/logo-bpr-resmi.png" alt="Logo BPR" style={{ width: '50px', height: 'auto', objectFit: 'contain' }} />
          </div>
          Smart Monitoring
        </div>
      </div>
