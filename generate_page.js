...
const code = `import { getCurrentUser } from '@/lib/session';
  ...
  return (
    <section className="card" style={{ padding: 24, marginBottom: 24, overflowX: 'auto' }}>
      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
        <thead>
          <tr style={{ backgroundColor: '#a5f3fc', color: '#000', border: '1px solid #000' }}>
            <th style={{ textAlign: 'left', padding: '4px 8px', border: '1px solid #000', width: '25%' }}>{title}</th>
            <th style={{ textAlign: 'right', padding: '4px 8px', border: '1px solid #000' }}>NON NPL</th>
            <th style={{ textAlign: 'right', padding: '4px 8px', border: '1px solid #000' }}>NPL</th>
            <th style={{ textAlign: 'right', padding: '4px 8px', border: '1px solid #000' }}>Grand Total</th>
            <th style={{ textAlign: 'center', padding: '4px 8px', border: '1px solid #000' }}>%</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((item) => (
