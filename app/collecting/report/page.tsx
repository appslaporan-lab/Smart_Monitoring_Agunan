...
export default async function CollectingReportPage() {
  ...
  return (
    <main className="container">
      <section style={{ marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12 }}>
        ...
        <Link href="/collecting" className="button secondary">Kembali ke Dashboard</Link>
      </section>
      ...
      <section className="card" style={{ padding: 24 }}>
        <h2>Non NPL vs NPL per Agunan</h2>
