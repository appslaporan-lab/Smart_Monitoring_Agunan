      ...
      <section style={{ marginBottom: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <a 
              href={`/api/collecting/export-rekap?periodeId=${periodeAktif.id}`} 
              className="button" 
              style={{ padding: '6px 12px', background: '#10b981', display: 'inline-flex', alignItems: 'center', gap: '6px', textDecoration: 'none' }}
              target="_blank"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" x2="12" y1="15" y2="3"/></svg>
              Ekspor Rekap Kunjungan
            </a>
          </div>
