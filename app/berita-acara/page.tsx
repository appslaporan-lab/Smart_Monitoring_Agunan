...
import CariAgunanForm from './CariAgunanForm';
    ...
    <div style={{ animation: 'fadeIn 0.3s ease' }}>
      <div style={{ marginBottom: 32, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '16px' }}>
        <div>
          ...
          <p style={{ color: '#64748b', fontSize: '1.05rem', margin: 0 }}>Buat dan kelola Berita Acara serah terima agunan secara terpusat.</p>
        </div>
        <Link href="/berita-acara/manual" className="button secondary" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          Buat Berita Acara Manual (Belum Register)
        </Link>
      ...
      <h2 style={{ marginTop: 8 }}>Berita Acara Tersimpan</h2>
