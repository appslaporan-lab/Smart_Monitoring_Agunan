          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
            <thead>
              <tr style={{ background: '#1e3a8a', color: 'white' }}>
                ...
                <th style={{ padding: '5px 8px', textAlign: 'left', width: '20%' }}>Jenis Agunan</th>
                <th style={{ padding: '5px 8px', textAlign: 'left', width: '30%' }}>Identitas (No. BPKB / SHM / Plat)</th>
            ...
            <tbody>
              {allAgunans.map((ag, idx) => (
                <tr key={ag.id} style={{ background: idx % 2 === 0 ? '#ffffff' : '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                  ...
                  <td style={{ padding: '5px 8px' }}>{ag.jenis}</td>
                  <td style={{ padding: '5px 8px' }}>{ag.nomorBPKB || ag.nomorSHM || ag.nomorPolisi || '-'}</td>
                  <td style={{ padding: '5px 8px' }}>{ag.namaPemilik || ag.namaPemilikSHM || '-'}</td>
                </tr>
              ))}
            </tbody>
          </table>
